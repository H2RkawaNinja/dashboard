-- ============================================================
-- BST Gang Management System v2.0
-- Komplette Datenbank – einfach in phpMyAdmin importieren
-- ============================================================

CREATE DATABASE IF NOT EXISTS gang_management CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE gang_management;
...
-- ============================================================
-- RANG-BERECHTIGUNGEN (Vorlage pro Rang)
-- ============================================================
...
INSERT INTO rank_permissions
    (rank_name, can_add_members, can_view_fence, can_manage_fence, can_view_recipes, can_manage_recipes,
...
VALUES
    ('Techniker', TRUE,  TRUE,  TRUE,  TRUE,  TRUE,  TRUE,  TRUE,  TRUE,  TRUE,  TRUE,  TRUE,  TRUE,  TRUE),
    ('OG',        TRUE,  TRUE,  TRUE,  TRUE,  TRUE,  TRUE,  TRUE,  FALSE, TRUE,  TRUE,  TRUE,  TRUE,  FALSE),
    ('2OG',       FALSE, TRUE,  TRUE,  TRUE,  TRUE,  TRUE,  TRUE,  FALSE, TRUE,  FALSE, TRUE,  TRUE,  FALSE),
    ('Member',    FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE),
    ('Soldat',    FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE),
    ('Runner',    FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE)
...
CREATE TABLE IF NOT EXISTS hero_inventory (
    ...
    unit_cost       DECIMAL(10,2) DEFAULT 150,
    sale_price      DECIMAL(10,2) DEFAULT 250,
...
CREATE TABLE IF NOT EXISTS hero_distributions (
    ...
    expected_sale_price DECIMAL(15,2) DEFAULT 0,
    gang_share          DECIMAL(15,2) DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS hero_sales (
    ...
    gang_share      DECIMAL(15,2) DEFAULT 0,
    member_share    DECIMAL(15,2) DEFAULT 0,
    paid_to_gang    BOOLEAN DEFAULT FALSE,
...
CREATE TABLE IF NOT EXISTS hero_distributions_archive (
    ...
    distributed_date TIMESTAMP NULL,
    status           VARCHAR(20),
    notes            TEXT,
    archived_by      INT,
    delivery_number  INT,
...
INSERT INTO gang_treasury (current_balance, contributions_balance, goals_balance, wochenbeitrag_standard, notes)
VALUES (0.00, 0.00, 0.00, 50.00, 'Startsaldo der Gangkasse')
